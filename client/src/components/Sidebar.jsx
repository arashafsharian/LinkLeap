    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          {/* Header */}
          <div className="p-4 pb-[27px] border-b border-gray-300 flex justify-between items-center">
            <h2 className="text-xl font-bold text-gray-800">Matches</h2>
            <button
              className="lg:hidden p-1 text-gray-700 hover:text-gray-500 focus:outline-none"
      ...
      <button
        className="lg:hidden absolute top-4 left-4 p-2 bg-cyan-700 text-white rounded-md z-0"
        onClick={toggleSidebar}
      >
